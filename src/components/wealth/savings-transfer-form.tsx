  ...
  return (
    <Dialog open={resolvedOpen} onOpenChange={setResolvedOpen}>
      ...
      <DialogContent className="sm:max-w-[520px]">
        ...
        {accounts.length === 0 ? (
          <div className="rounded-lg border border-border/70 bg-secondary/35 p-4 text-sm text-muted-foreground">
            {t(
          ...
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-5">
            ...
            <div className="rounded-lg border border-border/70 bg-secondary/35 p-3 text-sm text-muted-foreground">
