...
import { InvestmentAssetFields } from "@/components/wealth/investment-asset-fields";
import {
  Select,
  SelectContent,
  SelectItem,
      ...
      <SheetContent className="w-full overflow-y-auto p-0 sm:max-w-[760px]">
        <form className="flex h-full flex-col" onSubmit={form.handleSubmit(handleSubmit)}>
          ...
          <div className="flex-1 space-y-5 px-5 py-5">
            ...
            <div className="rounded-xl border border-border/70 bg-secondary/35 p-4 text-sm">
