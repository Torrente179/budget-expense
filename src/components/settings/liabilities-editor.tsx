  ...
  return (
    <Card className="border-border/50">
      ...
      <CardContent className="space-y-4">
        ...
        {showForm ? (
          <div className="space-y-3 rounded-[1.15rem] bg-secondary/40 p-3 ring-1 ring-border">
...
function LiabilityRow({
  ...
  return (
    <li className="space-y-2 rounded-[1.15rem] bg-card/96 p-3 ring-1 ring-border">
