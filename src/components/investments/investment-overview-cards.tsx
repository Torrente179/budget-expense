            ...
            <CardContent className="space-y-3 p-4 md:space-y-4 md:p-5">
              <div className="flex items-start justify-between gap-2">
                <div className="space-y-2">
                  <p className="text-[0.68rem] uppercase tracking-[0.24em] text-muted-foreground md:text-[0.72rem] md:tracking-[0.28em]">
                    {card.label}
                  </p>
                  <p className="font-heading text-[1.35rem] font-semibold leading-none tracking-[-0.04em] md:text-[2rem]">
                    {card.value}
                  </p>
                </div>
